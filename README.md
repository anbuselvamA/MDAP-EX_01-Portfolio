...
<html lang="en">
  ...
  <body oncontextmenu="return false">
    <header class="header" id="header">
      <nav class="nav container">
        <a href="#" class="nav__logo">Anbuselvam A</a>
        ...
        <div class="home__container container grid">
          <div class="home__content grid">
            ...
            <div class="home__data">
              <h1 class="home__title">Hi, I'm Anbuselvam A</h1>
        ...
        <div class="about__container container grid">
          ...
          <div class="about__data">
            ...
            <div class="about__buttons">
              <a download="" href="Resume-Prema (3).pdf" class="button button--flex">
  ...
  <div class="contact__container container grid">
    <div>
      <div class="contact__information">
        ...
        <div>
          ...
          <span class="contact__subtitle">
            <a href="tel:8124694321">8124694321</a>
          </span>
        </div>
      </div>
      ...
      <div class="contact__information">
        ...
        <div>
          ...
          <span class="contact__subtitle">anbuarumugam871@gmail.com</span>
        </div>
      </div>
      ...
      <div class="contact__information">
        ...
        <div>
          ...
          <span class="contact__subtitle">Chennai, Tamilnadu, India</span>
        </div>
      </div>
    </div>
    ...
    <form id="contactForm" class="contact__form grid">
      ...
      <div class="contact__content">
        <label class="content__label">Message</label>
    ...
    <footer class="footer">
      <div class="footer__bg">
        <div class="footer__container container grid">
          <div>
            <h1 class="footer__title">Anbuselvam A</h1>
        ...
        <p class="footer__copy">&#169; Anbuselvam A. All right reserved</p>
      </div>
    </footer>
...
## OUTPUT
<img width="1920" height="1080" alt="Screenshot (22)" src="https://github.com/user-attachments/assets/0f6f0199-5502-4b61-b0e5-7577aa70c784" />
<img width="1920" height="1080" alt="Screenshot (23)" src="https://github.com/user-attachments/assets/173560ab-8eb3-4699-8857-de9bc227f66d" />
<img width="1920" height="1080" alt="Screenshot (24)" src="https://github.com/user-attachments/assets/0f52932a-40b6-4cdb-9f30-350ae39e01fc" />
<img width="1920" height="1080" alt="Screenshot (25)" src="https://github.com/user-attachments/assets/d6a5b8ac-b9ae-43e5-b840-545fcb4598ee" />
<img width="1920" height="1080" alt="Screenshot (26)" src="https://github.com/user-attachments/assets/c9bfef1c-e13c-4f7f-85d2-4f8e00196a22" />
